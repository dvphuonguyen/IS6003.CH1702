...
_C.TEST_ONLY = False
_C.WEIGHT = "../Result/01_deep_bimodal_regression_image/09-25_09-04/checkpoint_98.pkl"
_C.COMPUTE_PCC = True
_C.COMPUTE_CCC = True
# data set split config ------------------------------------------------------------------------------------------------
_C.OUTPUT_DIR = "D:/ERP_Project/Result/01_deep_bimodal_regression_image"
_C.DATA_ROOT =  "D:/ERP_Project/ChaLearn2016_tiny"
